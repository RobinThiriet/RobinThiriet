...
💻 Passionné par les **infrastructures sécurisées**, le **Cloud Computing** et la **cybersécurité**  
🚀 Je conçois des architectures sécurisées et j’automatise des environnements virtuels
...
Je travaille sur des environnements IT où la priorité est la **fiabilité**, la **sécurité** et l’**exploitabilité**.
...
- automatiser pour réduire les erreurs et améliorer la qualité de service

Mes compétences concrètes:
...
### ⚙️ Automatisation, scripting & CI/CD
...
![Stormshield](https://img.shields.io/badge/Stormshield-004B87?style=for-the-badge)
...
- Scripts réutilisables (idempotents) et modularité
...
- 🛡️ DevSecOps & scanning / SAST
- 📊 SOAR & SIEM avancé (Splunk, Elastic)
